        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <form:form action="${pageContext.request.contextPath}/appinfo/update" method="POST" modelAttribute="appinfo" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label class="col-md-3 control-lable" for="notificationl_interval">Интервал за изпращане на нотификации</label>
                            <div class="col-md-7">
                                <form:input type="text" path="notificationInterval" id="notificationl_interval" class="form-control input-sm" />
                                <div class="has-error">
                                    <form:errors path="notificationInterval" class="help-inline"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label class="col-md-3 control-lable" for="notification_group_list">Списък нотификационни групи:</label>
                            <div class="col-md-7">
                                <form:select id="notification_group_list" path="notificationGroupSet" items="${notificationGroupsList}" itemValue="id"
